			...
			<el-col :span="16">
				...
				<el-card shadow="hover">
					<el-steps align-center :active="currStep">
						<el-step title="步骤1" description="首先接入本博客站点"></el-step>
						<el-step title="步骤2" description="提交您的站点信息"></el-step>
						<el-step title="步骤3" description="等待审核，邮件通知"></el-step>
					</el-steps>
					<div class="stepContent" v-if="currStep === 1">
						<div class="statement">
							<div class="item">博客链接：xxxxxxxxx</div>
							<div class="item">昵称：xxxxxxx</div>
							<div class="item">介绍：向上的路并不拥挤，而大多数人选择了安逸。</div>
						</div>
					</div>
					...
					<el-row type="flex" class="btn-tool" justify="space-around">
						<el-button icon="el-icon-circle-close-outline" v-if="currStep === 2" @click="lastStep">上一步</el-button>
						<el-button type="primary" icon="el-icon-circle-check-outline" @click="nextStep" v-if="currStep !== 3">下一步</el-button>
					</el-row>
				</el-card>
			</el-col>
		</el-row>
